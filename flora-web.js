...
var _user$project$FloraWeb$view = function (model) {
	return A3(
		...
		_debois$elm_mdl$Material_Color$DeepPurple,
		A4(
			...
			},
			{
				header: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('flora creative'),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				},
				...
				main: {
					ctor: '::',
					_0: _user$project$FloraWeb$mainContentview(model),
					_1: {ctor: '[]'}
				}
			}));
};
