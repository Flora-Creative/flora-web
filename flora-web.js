...
var _user$project$API$IOSApp = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
					return function (f) {
						return function (g) {
							return function (h) {
								return function (i) {
									return function (j) {
										return {appName: a, images: b, videoLinks: c, itunesUrl: d, appDescription: e, backgroundColor: f, foregroundColor: g, auIdentifier: h, appIcon: i, shortName: j};
									};
								};
							};
						};
...
var _user$project$API$decodeIOSApp = A3(
							...
							A3(
								...
								A3(
									...
									A3(
										...
										'appName',
										_elm_lang$core$Json_Decode$string,
										_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$API$IOSApp)))))))))));
var _user$project$API$get = function (urlBase) {
	return _elm_lang$http$Http$request(
		{
			method: 'GET',
			headers: {ctor: '[]'},
			...
			expect: _elm_lang$http$Http$expectJson(
				_elm_lang$core$Json_Decode$list(_user$project$API$decodeIOSApp)),
			timeout: _elm_lang$core$Maybe$Nothing,
			withCredentials: false
		});
};
var _user$project$API$getByName = F2(
	function (urlBase, capture_name) {
		return _elm_lang$http$Http$request(
			{
				method: 'GET',
				headers: {ctor: '[]'},
				url: A2(
					...
					'/',
					{
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$http$Http$encodeUri(capture_name),
							_1: {ctor: '[]'}
						}
					}),
				body: _elm_lang$http$Http$emptyBody,
				expect: _elm_lang$http$Http$expectJson(_user$project$API$decodeIOSApp),
				timeout: _elm_lang$core$Maybe$Nothing,
				withCredentials: false
			});
	});

var _user$project$FloraWeb$viewLocation = function (location) {
	return A2(
...
var _user$project$FloraWeb$basicStyle = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
...
var _user$project$FloraWeb$singleAppView = function (iOSApp) {
	return A2(
		...
		{
			ctor: '::',
			_0: _user$project$FloraWeb$basicStyle,
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			...
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html$text(iOSApp.appDescription),
				_1: {
					ctor: '::',
					_0: A2(
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$src(iOSApp.appIcon),
								_1: {ctor: '[]'}
							},
							{ctor: '[]'}),
						_1: {ctor: '[]'}
	...
	if (_p2.ctor === 'Just') {
		var _p3 = _elm_lang$core$List$head(
			A2(
				...
				model.apps));
		if (_p3.ctor === 'Just') {
			return _user$project$FloraWeb$singleAppView(_p3._0);
		} else {
			return A2(
				_elm_lang$html$Html$div,
				{
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('No content yet!'),
					_1: {ctor: '[]'}
				});
		}
	} else {
		return _user$project$FloraWeb$allAppView(model.apps);
	}
};
...
var _user$project$FloraWeb$loadingView = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html$text('we are loading'),
			_1: {ctor: '[]'}
		});
};
...
var _user$project$FloraWeb$Model = F3(
	function (a, b, c) {
		return {history: a, apps: b, hasFinishedLoading: c};
	});
var _user$project$FloraWeb$ReceivedAllApps = function (a) {
	return {ctor: 'ReceivedAllApps', _0: a};
};
var _user$project$FloraWeb$fetchAllApps = A2(
	_elm_lang$http$Http$send,
	_user$project$FloraWeb$ReceivedAllApps,
	_user$project$API$get('http://localhost:1234'));
var _user$project$FloraWeb$init = function (location) {
	return {
		ctor: '_Tuple2',
		_0: {
			history: {
		...
		_1: _user$project$FloraWeb$fetchAllApps
	};
};
var _user$project$FloraWeb$UrlChanged = function (a) {
	return {ctor: 'UrlChanged', _0: a};
};

var _user$project$Main$main = A2(
	_elm_lang$navigation$Navigation$program,
	_user$project$FloraWeb$UrlChanged,
	{init: _user$project$FloraWeb$init, view: _user$project$FloraWeb$view, update: _user$project$FloraWeb$update, subscriptions: _user$project$FloraWeb$subscriptions})();

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Dict.LeafColor":{"args":[],"tags":{"LBBlack":[],"LBlack":[]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":["Dict.LeafColor"]}},"FloraWeb.Msg":{"args":[],"tags":{"ReceivedAllApps":["Result.Result Http.Error (List API.IOSApp)"],"UrlChanged":["Navigation.Location"]}},"Dict.NColor":{"args":[],"tags":{"BBlack":[],"Red":[],"NBlack":[],"Black":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String"],"NetworkError":[],"Timeout":[],"BadStatus":["Http.Response String"],"BadPayload":["String","Http.Response String"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}}},"aliases":{"Http.Response":{"args":["body"],"type":"{ url : String , status : { code : Int, message : String } , headers : Dict.Dict String String , body : body }"},"API.IOSApp":{"args":[],"type":"{ appName : String , images : List String , videoLinks : List String , itunesUrl : String , appDescription : String , backgroundColor : String , foregroundColor : String , auIdentifier : String , appIcon : String , shortName : String }"},"Navigation.Location":{"args":[],"type":"{ href : String , host : String , hostname : String , protocol : String , origin : String , port_ : String , pathname : String , search : String , hash : String , username : String , password : String }"}},"message":"FloraWeb.Msg"},"versions":{"elm":"0.18.0"}});
}
