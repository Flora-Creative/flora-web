...
view =
    ...
    div myStyle
        ...
        , p [] [ text "We use cookies and similar tracking technologies to track the activity on our Service and hold certain information." ]
        , p [] [ text "Cookies are files with small amount of data which may include an anonymous unique identifier. Cookies are sent to your browser from a website and stored on your device. Tracking technologies also used are beacons, tags, and scripts to collect and track information and to improve and analyze our Service." ]
        , p [] [ text "You can instruct your browser to refuse all cookies or to indicate when a cookie is being sent. However, if you do not accept cookies, you may not be able to use some portions of our Service." ]
        , p [] [ text "Examples of Cookies we use:" ]
        , ul []
            [ li [] [ text "Session Cookies - We use Session Cookies to operate our Service." ]
        ...
        , ul []
            [ li [] [ text "To provide and maintain the Service" ]
            , li [] [ text "To notify you about changes to our Service" ]
            , li [] [ text "To allow you to participate in interactive features of our Service when you choose to do so" ]
            , li [] [ text "To provide customer care and support" ]
            , li [] [ text "To provide analysis or valuable information so that we can improve the Service" ]
        ...
        , p [] [ text "Your consent to this Privacy Policy followed by your submission of such information represents your agreement to that transfer." ]
        , p [] [ text "Flora Creative Limited will take all steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organization or a country unless there are adequate controls in place including the security of your data and other personal information." ]
        , h2 [ StyleSheet.semibold ] [ text "Disclosure Of Data" ]
        , h3 [ StyleSheet.semibold ] [ text "Legal Requirements" ]
        , p [] [ text "Flora Creative Limited may disclose your Personal Data in the good faith belief that such action is necessary to:" ]
        , ul []
            [ li [] [ text "To comply with a legal obligation" ]
            , li [] [ text "To protect and defend the rights or property of Flora Creative Limited" ]
            , li [] [ text "To prevent or investigate possible wrongdoing in connection with the Service" ]
        ...
        , ul []
            [ li []
                [ p [ StyleSheet.semibold ] [ text "Google Analytics" ]
                , p [] [ text "Google Analytics is a web analytics service offered by Google that tracks and reports website traffic. Google uses the data collected to track and monitor the use of our Service. This data is shared with other Google services. Google may use the collected data to contextualize and personalize the ads of its own advertising network." ]
                , p [] [ text "For more information on the privacy practices of Google, please visit the Google Privacy & Terms web page:" ]
